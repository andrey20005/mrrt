...
pub mod compute {
    pub const MAIN_PASS1_WORKGROUP_SIZE: [u32; 3] = [16, 16, 1];
    pub fn create_main_pass1_pipeline(device: &wgpu::Device) -> wgpu::ComputePipeline {
        let module = super::create_shader_module(device);
        let layout = super::create_pipeline_layout(device);
        device.create_compute_pipeline(&wgpu::ComputePipelineDescriptor {
            label: Some("Compute Pipeline main_pass1"),
            layout: Some(&layout),
            module: &module,
            entry_point: Some("main_pass1"),
            compilation_options: Default::default(),
            cache: Default::default(),
        })
    }
}
pub const SOURCE: &str = include_str!("path_splitter.wgsl");
...
pub const ENTRY_MAIN_PASS1: &str = "main_pass1";
#[repr(C)]
#[derive(Debug, Copy, Clone, PartialEq, encase :: ShaderType)]
pub struct PathData {
    pub color: glam::Vec3,

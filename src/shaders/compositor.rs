...
pub mod compute {
    pub const MAIN_PASS2_WORKGROUP_SIZE: [u32; 3] = [16, 16, 1];
    pub fn create_main_pass2_pipeline(device: &wgpu::Device) -> wgpu::ComputePipeline {
        let module = super::create_shader_module(device);
        let layout = super::create_pipeline_layout(device);
        device.create_compute_pipeline(&wgpu::ComputePipelineDescriptor {
            label: Some("Compute Pipeline main_pass2"),
            layout: Some(&layout),
            module: &module,
            entry_point: Some("main_pass2"),
            compilation_options: Default::default(),
            cache: Default::default(),
        })
    }
    pub const MAIN_DENOISE_WORKGROUP_SIZE: [u32; 3] = [16, 16, 1];
    pub fn create_main_denoise_pipeline(device: &wgpu::Device) -> wgpu::ComputePipeline {
        let module = super::create_shader_module(device);
        let layout = super::create_pipeline_layout(device);
        device.create_compute_pipeline(&wgpu::ComputePipelineDescriptor {
            label: Some("Compute Pipeline main_denoise"),
            layout: Some(&layout),
            module: &module,
            entry_point: Some("main_denoise"),
            compilation_options: Default::default(),
            cache: Default::default(),
        })
    }
}
pub const SOURCE: &str = include_str!("compositor.wgsl");

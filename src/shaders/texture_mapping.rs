...
pub mod bind_groups {
    ...
    pub struct BindGroupLayout0<'a> {
        pub my_texture: &'a wgpu::TextureView,
        pub my_sampler: &'a wgpu::Sampler,
    }
        ...
        pub fn from_bindings(device: &wgpu::Device, bindings: BindGroupLayout0) -> Self {
            ...
            let bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
                ...
                entries: &[
                    wgpu::BindGroupEntry {
                        binding: 0,
                        resource: wgpu::BindingResource::TextureView(bindings.my_texture),
                    },
                    wgpu::BindGroupEntry {
                        binding: 1,
                        resource: wgpu::BindingResource::Sampler(bindings.my_sampler),
                    },
                ],
...
pub const SOURCE: &str = include_str!("texture_mapping.wgsl");
